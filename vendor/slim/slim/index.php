  ...
  <!DOCTYPE html>
   <html alng="pt-BR">
    ...
    <body>
     ...
     <p>
      Congratulations!<br />
      Your Slim application is running.<br />
      If this is your first time using Slim, start with this <a href="http://www.slimframework.com/learn" target="_blank">"Hello World" Tutorial</a>.
     </p>
     <section>
     <h2>Get Started</h2>
     <ol>
    ...
    <section>
     ...
     <p>
      ...
      to read announcements, chat with fellow Slim users, ask questions, help others, or show off your cool Slim Framework apps.
     </p>
     
     <h3>Twitter</h3>
     <p>
      Follow <a href="http://www.twitter.com/slimphp" target="_blank">@slimphp</a> on Twitter to receive the very latest news and updates about the framework.
     </p>
    </section>
    ...
    <p>
     <a href="https://github.com/codeguy/Slim-Extras" target="_blank">
 ...
 * This executes the Slim application
